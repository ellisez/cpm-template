<template>
  <div class="detailWrap">
    ...
    <div class="list">
      ...
      <div class="picture">
        <div class="tit">
          <img src="../../assets/iconD/picture.png">
          <span>图文</span>
        </div>
      ...
      <div class="video">
        <div class="tit">
          <img src="../../assets/iconD/video.png">
          <span>音视频</span>
        </div>
        <div class="commonList">
          <div
      ...
      <div class="meeting">
        <div class="tit">
          <img src="../../assets/iconD/meeting.png">
          <span>会议</span>
        </div>
        <div class="commonList">
          <div
...
.topWrap {
  height: 1.6rem;
  background: url("../../assets/imagesD/bg_top.png") no-repeat center center;
