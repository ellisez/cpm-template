...
">{{targetCount}}人</em>
    ...
    >
      <div class="first819tk">
        <img src="../../assets/819/indexTk_bg.png" alt class="bg_819" />
...
.activityEntry_cicle {
  ...
  border-radius: 50%;
  //   background: #39b9d4;
  background: url(../../assets/819/activityEntry_cicle.png) no-repeat no-repeat;
...
.tuiHelp {
  ...
  background: url(../../assets/icons/tuiHelp.png) no-repeat no-repeat;
  background-size: 100% 100%;
  width: 14px;
  height: 14px;
...
.indexWrap {
  ...
  .topSearch {
    ...
    .searchBar {
      ...
      .serchIcon {
        ...
        height: 0.1rem;
        margin-right: 0.1rem;
        background: url("../../assets/iconD/search.png") no-repeat center;
  ...
  .month {
    .title {
      ...
      span {
        ...
        font-size: 10px;
        background: url("../../assets/iconD/right.png") no-repeat right;
  ...
  .linkBox {
    ...
    .read {
      i {
        background: url("../../assets/iconD/noread.png") no-repeat center;
        background-size: 42px 42px;
      }
    }
    .push {
      i {
        background: url("../../assets/iconD/nopush.png") no-repeat center;
        background-size: 42px 42px;
      }
    }
  }
...
.first819tk {
  ...
  &_footer {
    width: 1.2rem;
    height: 0.28rem;
    background: url(../../assets/819/indexTk_btn.png) no-repeat no-repeat;
