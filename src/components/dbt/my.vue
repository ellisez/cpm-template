  ...
  <div class="myWrap">
    ...
    <div class="msgBox">
      <div class="itemBox" data-flex="main:justify cross:center">
        <div class="img">
          <img src="../../assets/iconD/header.png" />
        </div>
        <div class="info">
    ...
    <div class="listBox">
      <div class="item" @click="newMsg" data-flex="main:left cross:center">
        <div>
          <img src="../../assets/iconD/message.png" />
        </div>
        <p>
          消息通知
      ...
      <div @click="qrCode" class="item" data-flex="main:left cross:center">
        <div>
          <img src="../../assets/iconD/qrcode.png" />
        </div>
        <p>我的二维码</p>
      </div>
      <div @click="myCustomer" class="item" data-flex="main:left cross:center">
        <div>
          <img src="../../assets/iconD/my_customer.png" />
        </div>
        <p>我的客户</p>
      </div>
      <div
      ...
      >
        <div>
          <img src="../../assets/iconD/my_meeting.png" />
        </div>
        <p>青年演说家申请</p>
      </div>
      ...
      <div class="item" @click="helpList" data-flex="main:left cross:center">
        <div>
          <img src="../../assets/iconD/my_help.png" />
        </div>
        <p>帮助文档</p>
      </div>
      <!-- <div class="item" data-flex="main:left cross:center">
...
.myWrap {
  ...
  .listBox {
    ...
    .item {
      ...
      line-height: 0.66rem;
      overflow: hidden;
      background: url("../../assets/iconD/my_more.png") no-repeat 95% center;
  ...
  .userBox {
    height: 1.28rem;
    background: url("../../assets/imagesD/my_top.png") no-repeat center center;
