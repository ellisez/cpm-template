  ...
  <div class="searchWrap">
    ...
    <div class="content">
        ...
        >
          <div class="left">
            <div class="name" data-flex="main:left cross:center">
              <img v-if="item.isBind === 1" src="../../assets/iconD/important.png" />
              <img v-if="item.isBind !== 1" src="../../assets/iconD/doctor.png" />
              <p>
          ...
          <div @click="doctorDetail(item)" class="right">
            <img src="../../assets/iconD/right.png" />
          </div>
        </div>
      </div>
      <div v-if="type === '3'" class="hospital">
        ...
        >
          <div class="num">
            <img src="../../assets/iconD/hospital.png" />
          </div>
...
.noContent {
  ...
  left: 0;
  top: 0.5rem;
  background: url("../../assets/imagesD/position.d53faac.png") no-repeat center;
