      ...
      <div class="e-date-select">
        <div class="e-date-monthday">
          <div class="e-calendar-toolbar">
            <div @click="prevMonth">
              <img style="width:10px;height:15px" src="../../../assets/iconD/prev.png" />
            </div>
            ...
            <div @click="nextMonth">
              <img style="width:10px;height:15px" src="../../../assets/iconD/next.png" />
            </div>
          </div>
        </div>
      </div>
    ...
    &-row {
      ...
      &-day {
        ...
        &.disabled {
          ...
          background: url("../../../assets/iconD/lock.png") no-repeat center
            center;
          background-size: 26px 26px;
          text-align: center;
        }
        &.invited {
          background-image: url("../../../assets/iconD/invited.png");
