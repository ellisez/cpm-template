...
.positionWrap {
  ...
  .list {
    ...
    .title {
      ...
      width: 1.6rem;
      top: -0.14rem;
      background: url("../../../assets/iconD/top.png") no-repeat center;
    ...
    .listBox {
      ...
      top: 0.08rem;
      width: 1.6rem;
      background: url("../../../assets/iconD/middle.png") repeat-y center;
      background-size: 1.6rem 0.24rem;
      .item {
        height: 0.4rem;
        line-height: 0.4rem;
    ...
    .bottom {
      ...
      width: 1.6rem;
      bottom: -0.2rem;
      background: url("../../../assets/iconD/bottom.png") no-repeat center;
      background-size: 1.6rem 0.24rem;
      position: absolute;
    }
  }
