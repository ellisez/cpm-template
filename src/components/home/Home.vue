    ...
    <div v-show="isRepresent === 'N'">
      ...
      <div class="audio-box" v-if="voiseInfo" @click.stop="toVioce">
        <div class="left">
          <div class="img" @click.stop="palyVoise">
            <img :class="{'voise-bg':playing}" src="../../assets/images/pic_mrtx.png" alt />
            <div class="mask"></div>
      ...
      >
        <div class="first819tk">
          <img src="../../assets/819/indexTk_bg_ysd.png" alt class="bg_819" />
...
import indexDBT from '../../components/dbt/index'
...
.activityEntry_cicle {
  ...
  border-radius: 50%;
  //   background: #39b9d4;
  background: url(../../assets/819/activityEntry_cicle-red.png) no-repeat
    no-repeat;
