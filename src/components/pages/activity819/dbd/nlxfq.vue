        ...
        <div class="list" v-if="nlData">
          <div class="nlxfq_item" v-for="(item,index) in nlData.dTaskOrderList" :key="index">
            <div class="iconW" v-if="index <3">
              <img :src="require(`../../../../assets/819/jinpai${index+1}.png`)" alt />
            </div>
            <div class="nlxfq_avatar">
              <!-- {{'champion'+index}} -->
              <!-- {{`../../../../assets/819/champion${index}.png`}} -->
              <img :src="require(`../../../../assets/819/champion${index}.png`)" alt />
            </div>
...
.nlxfq {
  ...
  //   );
  background: url(../../../../assets/819/nlxxf_bg.png) no-repeat no-repeat;
...
.mytask_footer {
  ...
  &_wrap {
    ...
    .taskBtn {
      width: 1.3rem;
      height: 0.39rem;
      background: url(../../../../assets/819/nlxxf-my_bg.png) no-repeat
        no-repeat;
      background-size: 100% 100%;
      border-radius: 8px;
      color: #fff;
      ...
      text-align: center;
      &.lqrw {
        background: url(../../../../assets/819/nlxxf-my_bg-l.png) no-repeat
          no-repeat;
        background-size: 100% 100%;
