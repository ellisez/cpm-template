  ...
  <div :class="['activity819','fck','fck'+$route.query.code]" :key="$route.query.url">
    ...
    >
      ...
      <div class="zsbk">
        <img
          class="iconbk"
          src="../../../../assets/819/style819_white.png"
          v-if="$route.query.code=== '1' || $route.query.code=== '3' || $route.query.code=== '4' || $route.query.code=== '6'"
          alt
        />
        <img class="iconbk" src="../../../../assets/819/style819_red.png" v-else alt />
      ...
      >
        <div class="footer_l">
          <img
            src="../../../../assets/819/footer_l_3.png"
            v-if="$route.query.code=== '3' || $route.query.code=== '4'"
            alt
          />
          <img src="../../../../assets/819/footer_l.png" v-else alt />
        </div>
...
export default {
  ...
  data () {
    return {
      ...
      style1Img: require(`../../../../assets/819/style${this.$route.query.code}.png`),
      imgData: {}, // 人头数据
      arrImg: [], // 判断图片有没有加载完
      hongse: [
        // 风采大赏
