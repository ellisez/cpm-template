    ...
    <div class="jfrw_wrap">
      <div class="jfrw_con">
        <div class="jfrw_wrap_top">
          <img src="../../../../assets/819/jfrw_top.png" alt />
        </div>
        <!-- 文章阅读 -->
        <div class="jfrw_item">
        ...
        <div class="fz">
          <!-- {{isActivityEnd}} -->
          <img src="../../../../assets/819/fzyjx.png" class="fz_img" @click="_is819uploadCount" alt />
        </div>
      </div>
    </div>
  </div>
...
.jfrw {
  ...
  &_item {
    ...
    .wenzhangIcon {
      width: 0.1rem;
      height: 0.1rem;
      background: url(../../../../assets/819/wenzhang_icon.png) no-repeat
        no-repeat;
    ...
    .jfrw_item-Group_bg.wenzhang1 {
      background: url(../../../../assets/819/wenzhang1.png) no-repeat no-repeat;
      background-size: 100% 100%;
    }
    .jfrw_item-Group_bg.wenzhang2 {
      background: url(../../../../assets/819/wenzhang2.png) no-repeat no-repeat;
      background-size: 100% 100%;
    }
    .jfrw_item-Group_bg.wenzhang3 {
      background: url(../../../../assets/819/wenzhang3.png) no-repeat no-repeat;
      background-size: 100% 100%;
    }
    .jfrw_item-Group_bg.zhibo1 {
      background: url(../../../../assets/819/zhibo1.png) no-repeat no-repeat;
      background-size: 100% 100%;
    }
    .jfrw_item-Group_bg.zhibo2 {
      background: url(../../../../assets/819/zhibo2.png) no-repeat no-repeat;
      background-size: 100% 100%;
    }
    .jfrw_item-Group_bg.zhibo3 {
      background: url(../../../../assets/819/zhibo3.png) no-repeat no-repeat;
      background-size: 100% 100%;
    }
    .jfrw_item-Group_bg.huoyue1 {
      background: url(../../../../assets/819/huoyue1.png) no-repeat no-repeat;
      background-size: 100% 100%;
    }
    .jfrw_item-Group_bg.huoyue2 {
      background: url(../../../../assets/819/huoyue2.png) no-repeat no-repeat;
      background-size: 100% 100%;
    }
    .jfrw_item-Group_bg.huoyue3 {
      background: url(../../../../assets/819/huoyue3.png) no-repeat no-repeat;
      background-size: 100% 100%;
    }
  }
  &_con {
