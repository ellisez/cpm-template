...
.audio-play-box {
  ...
  .play-icon {
    width: 0.4rem;
    height: 0.4rem;
    background: url("../../../assets/icons/audio_play.png") no-repeat center
      center;
    background-size: 100% 100%;
    float: left;
  }
  .pause {
    background: url("../../../assets/icons/puase-audio.png") no-repeat center
      center;
    background-size: 100% 100%;
  }
  .right {
    ...
    .readNum-duration-box {
      ...
      .read-num {
        ...
        .read-icon {
          width: 0.13rem;
          height: 0.2rem;
          background: url("../../../assets/icons/read.png") no-repeat center
            center;
