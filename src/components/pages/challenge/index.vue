<template>
  <div class="box">
    ...
    <div class="tab">
      参考文献
      <img v-show="!canAnswer" src="../../../assets/images/hand.png" class="hand" alt>
    </div>
...
.box {
  ...
  .tab {
    ...
    background: url("../../../assets/icons/talk.png") no-repeat left center;
    ...
    .item-info {
      ...
      .nums {
        ...
        .read {
          ...
          background: url("../../../assets/icons/read.png") no-repeat left
            center;
          background-size: 0.2rem auto;
        ...
        .praise {
          ...
          background: url("../../../assets/icons/praise.png") no-repeat left
            center;
