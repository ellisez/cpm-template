    ...
    <div class="comment-box">
      ...
      <div class="btns-comment">
        ...
        <img
          ...
          v-show="isVote == 0"
          @click="praise"
          src="src1/assets/icons/add-praise.png"
        >
        <img
          class="praise"
          v-show="isVote == 1"
          @click="praise"
          src="src1/assets/icons/addpra_active.png"
        >
        <!--  收藏按钮 -->
        <img
          class="collect ewq"
          v-show="isCollect == 0"
          @click="collect"
          src="src1/assets/icons/add-collection.png"
        >
        <img
          class="collect"
          v-show="isCollect == 1"
          @click="collect"
          src="src1/assets/icons/cang_active.png"
        >
        <!-- 分享 -->
        <img
          class="collect ewq"
          v-show="showShare"
          @click="share"
          src="src1/assets/icons/share.png"
        >
      </div>
    </div>
