<template>
  <div class="activity517">
    <!-- kv -->
    <img src="src1/assets/517/index-kv.png" alt="">
    ...
    <!-- 活动部分 -->
    <div class="act-info">
      <img src="src1/assets/517/index-info.png" alt="">
      <!-- 抽奖部分 -->
      <div class="act-box">

        <div class="info-box">
          <!-- 20积分 -->
          <img v-show="actIndex != 7" src="src1/assets/517/score-1.png" alt="">
          <img v-show="actIndex == 7" src="src1/assets/517/score-1-a.png" alt="">
          <!-- 谢谢参与 -->
          <img v-show="actIndex != 0" src="src1/assets/517/score-2.png" alt="">
          <img v-show="actIndex == 0" src="src1/assets/517/score-2-a.png" alt="">
          <!-- 50积分 -->
          <img v-show="actIndex != 1" src="src1/assets/517/score-3.png" alt="">
          <img v-show="actIndex == 1" src="src1/assets/517/score-3-a.png" alt="">
        </div>

        <div class="info-box">
          <!-- 10积分 -->
          <img v-show="actIndex != 6" src="src1/assets/517/score-4.png" alt="">
          <img v-show="actIndex == 6" src="src1/assets/517/score-4-a.png" alt="">
          <!-- 点击抽奖 -->
          <img v-show="clickDown" @click="startLottery" src="src1/assets/517/score-6.png" alt="">
          <img v-show="!clickDown" @click="added" src="src1/assets/517/score-6-a.png" alt="">
          <!-- 10积分 -->
          <img v-show="actIndex != 2" src="src1/assets/517/score-4.png" alt="">
          <img v-show="actIndex == 2" src="src1/assets/517/score-4-a.png" alt="">
        </div>

        <div class="info-box">
          <!-- 10积分 -->
          <img v-show="actIndex != 5" src="src1/assets/517/score-5.png" alt="">
          <img v-show="actIndex == 5" src="src1/assets/517/score-5-a.png" alt="">
          <!-- 20积分 -->
          <img v-show="actIndex != 4" src="src1/assets/517/score-1.png" alt="">
          <img v-show="actIndex == 4" src="src1/assets/517/score-1-a.png" alt="">
          <!-- 50积分 -->
          <img v-show="actIndex != 3" src="src1/assets/517/score-3.png" alt="">
          <img v-show="actIndex == 3" src="src1/assets/517/score-3-a.png" alt="">
        </div>
      </div>
      ...
      <div class="rules-box">
        ...
        <div class="rule-btn" :class="{'active':showRules}" @click="showRule">
          <img v-show="!showRules" src="src1/assets/517/btn.png" alt="">
          <img v-show="showRules" src="src1/assets/517/btn-a.png" alt="">
          <div>活动规则</div>
        </div>
        <!-- 我的奖品 -->
        <div class="rule-btn" :class="{'active':showRules}" @click="showMyGood">
          <img v-show="!showMyGoods" src="src1/assets/517/btn.png" alt="">
          <img v-show="showMyGoods" src="src1/assets/517/btn-a.png" alt="">
          <div>我的奖品</div>
        </div>
      </div>
    ...
    <img src="src1/assets/517/index-bnner-top.png" alt="">
    <!-- 礼品展示 -->
    <div class="banner-box" @touchstart='bannerStart' @touchend='bannerEnd'>
      <!-- banner背景 -->
      <img src="src1/assets/517/banner-bg.png" alt="">
      ...
      <div class="banner">
        ...
        >
          <img class="banner-bg" src="src1/assets/517/banner-info-bg.png" alt="">

            <img class="good-img" src="src1/assets/517/tzq.png" alt="">
          <div class="goods">
            <div class="goods-des">
        ...
        >
          ...
          <img class="good-img up" src="src1/assets/517/up.png" alt="">
          <div class="goods">
            <div class="goods-des">
        ...
        >
          ...
          <img class="good-img" src="src1/assets/517/bjb.png" alt="">
          <div class="goods">
            <div class="goods-des">
    ...
    <Popup v-model="showMyGoods" @closed='showMyGoods = false'>
      <div class="my-goods">
        <img src="src1/assets/517/my-goods-hd.png" alt="">
        <div class="popup-info">
          ...
          <div class="act-btn" @click="showMyGoods = false">
            <img src="src1/assets/517/toast-btn.png" alt="">
            <div>好的</div>
          </div>
        </div>
        <img src="src1/assets/517/bottom.png" alt="">
      </div>
    </Popup>
    <!-- 活动规则弹窗 -->
    <Popup v-model="showRules" @closed='showMyGoods = false'>
      <div class="activity-rules">
        ...
        <img src="src1/assets/517/activity-rules.png" alt="">
    ...
    <Popup class="toast" v-model="showTopicAsk" @closed='bindTopicAsk'>
      <div class="topic-ask">
        ...
        <img src="src1/assets/517/toast.png" alt="">
    ...
    <Popup v-model="showTopic" @closed='topicClose'>
      <div class="topic">
        <img src="src1/assets/517/answer-title.png" alt="">
...
@import url('src1/styleivity517.less');
// .box {
