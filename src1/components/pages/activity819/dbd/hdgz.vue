...
.gzCon {
  ...
  &_bg {
    width: 0.9rem;
    height: 0.32rem;
    background: url(src1/assets/819/gzCon_tit.png) no-repeat no-repeat;
...
.hdgz {
  ...
  &_gzjs {
    ...
    text-align: center;
    color: #fff;
    background: url(src1/assets/819/hdgz_gzjs.png) no-repeat no-repeat;
    background-size: contain;
    &.sj {
      background: url(src1/assets/819/hdgz_gzsj.png) no-repeat no-repeat;
      background-size: contain;
    }
  }
  &_desc {
    ...
    .duanhao_l {
      width: 0.43rem;
      height: 0.31rem;
      background: url(src1/assets/819/dunhao_l.png) no-repeat no-repeat;
      background-size: 100% 100%;
      position: absolute;
      left: -0.2rem;
      top: -0.15rem;
    ...
    .duanhao_r {
      width: 0.43rem;
      height: 0.31rem;
      background: url(src1/assets/819/dunhao_r.png) no-repeat no-repeat;
      background-size: 100% 100%;
      position: absolute;
      right: -0.4rem;
      bottom: -0.2rem;
