<template>
  <div class="activity819">
    ...
    <div class="activity819_top">
      <img src="src1/assets/819/activity819Top.png" alt />
    </div>
    <div class="activity819_con">
      <img src="src1/assets/819/activity819_con.png" alt />
    ...
    <y-dialog :showModel="dialogShow_task_select" @hideDialog="hideDialogInfo_select">
      <div class="taskSelectDia">
        <div class="taskSelectDia_tit">
          <img src="src1/assets/819/task_select.png" alt />
        </div>
      ...
      <div class="first819tk" :style="taskRandomBg">
        ...
        <div class="first819tk_desc" v-if="taskDetail">
          ...
          <p class="p2">
            ...
            <span>
              <img
                src="src1/assets/819/star_active.png"
                alt
        ...
        <div class="closeX" @click="dialogShow_task=false">
          <img src="src1/assets/819/closeX.png" alt />
        </div>
      </div>
    </y-dialog>
  </div>
...
export default {
  ...
  data () {
    return {
      ...
      taskRandomBg: {
        color: l ? '#fff' : '#333',
        backgroundImage: `url(${require(`./src1/assets`)})`
      },
  ...
  methods: {
    ...
    showTask (item) {
      ...
      serviceApi.queryTaskDesc({ id }).then(res => {
        ...
        this.hideLoad()
        this.taskRandomBg.backgroundImage = `url(${require(`./src1/assets`)})`
...
.activity819 {
  ...
  &Game {
    ...
    top: 0;
    background: url(src1/assets/819/guidao.png) no-repeat no-repeat;
...
.task {
  ...
  &1 {
    top: 0;
    left: 0.25rem;
    background: url(src1/assets/819/task1.png) no-repeat no-repeat;
    background-size: 100% 100%;
  }
  &2 {
    top: 0;
    left: 1.4rem;
    background: url(src1/assets/819/task2.png) no-repeat no-repeat;
    background-size: 100% 100%;
  }
  &3 {
    top: 0.7rem;
    left: 2.4rem;
    background: url(src1/assets/819/task3.png) no-repeat no-repeat;
    background-size: 100% 100%;
  }
  &4 {
    top: 1.7rem;
    left: 2.2rem;
    background: url(src1/assets/819/task4.png) no-repeat no-repeat;
    background-size: 100% 100%;
  }
  &5 {
    width: 0.5rem;
    ...
    top: 1.5rem;
    left: 1.2rem;
    background: url(src1/assets/819/task5.png) no-repeat no-repeat;
    background-size: 100% 100%;
  }
  &6 {
    width: 0.5rem;
    ...
    bottom: -10px;
    right: 2.2rem;
    background: url(src1/assets/819/task6.png) no-repeat no-repeat;
    background-size: 100% 100%;
  }
}
...
.mytask_footer {
  ...
  &_wrap {
    ...
    .taskBtn {
      width: 1.31rem;
      height: 0.39rem;
      background: url(src1/assets/819/Btn_blue-wdrw.png) no-repeat
        no-repeat;
      background-size: contain;
      color: #49b8ff;
      line-height: 0.39rem;
      ...
      &.lqrw {
        width: 1.13rem;
        background: url(src1/assets/819/Btn_blue-nlxfq.png) no-repeat
          no-repeat;
        background-size: contain;
      }
    }
