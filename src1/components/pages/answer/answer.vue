          ...
          <div v-if="status==='3'" class="end">
            ...
            <div class="btnBox" data-flex="main:justify cross:center">
              ...
              <span style="color:#4631DC" @click="tryListen">试听
                <img class="try" v-show="showTry" src="src1/assets/images/playing.gif" alt="">
              </span>
            </div>
          </div>
  ...
  .answer {
    ...
    .end {
      ...
      .icon {
        ...
        width: 1rem;
        height: 1rem;
        background: url("src1/assets/icons/send_record.png");
    ...
    .stop {
      ...
      .icon {
        ...
        width: 1rem;
        height: 1rem;
        background: url("src1/assets/icons/stop.png");
        background-size: 1rem 1rem;
      }
      .txt {
    ...
    .prograss {
      ...
      .icon {
        width: 100px;
        height: 100px;
        background: url("src1/assets/icons/play_recored.png");
        position: absolute;
        left: 0px;
        top: 0px;
