<template>
  <div class="newsletter" v-show="list.length > 0">
    ...
    <div class="newsletter_top">
      <img src="src1/assets/images/newsletter-top_02.png" class="newsletter_top-img">
      <!-- <img src="../../../assets/images/newsletter-top_tit.png" class="newsletter_top-img"> -->
      <img src="src1/assets/images/newsletter-top_08.png" class="newsletter_top-yun">
      <img src="src1/assets/images/newsletter-top_08.png" class="newsletter_top-yun">
    </div>

    <div class="img" v-for="(item,index) in list" :key="index">
      <img src="src1/assets/images/newsletter-bg.png" alt @load="imgLoad(0)">
      ...
      >
        <img
          ...
          src="src1/assets/images/open-cus.png"
          alt
          @load="imgLoad(1)"
        >
        <img
          v-show="e.status == 'A'"
          src="src1/assets/images/close-cus.png"
          alt
          @load="imgLoad(2)"
        >
        <img
          v-show="e.status == 'B' && e.isPass"
          src="src1/assets/images/answered-cus.png"
          alt
          @load="imgLoad(3)"
        >
        ...
        <img
          class="hand"
          v-show="e.status == 'B' && !e.isPass"
          src="src1/assets/images/hand-gq.png"
          alt
        >
        <img
          class="new"
          v-show="e.status == 'B' && !e.isPass"
          src="src1/assets/images/new.png"
          alt
        >
      </div>
    </div>
...
@import url("src1/stylesletter.less");
