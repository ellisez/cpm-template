		...
		<div class="auth-upload ">
			...
			<div class="auth-up-example">
				<div class="clearfix" v-show="selectValue == 0">
					<img src="src1/assets/images/wo_renzhen_a_01.jpg">
					<img src="src1/assets/images/wo_renzhen_a_02.jpg">
				</div>
				<div class="clearfix" v-show="selectValue == 1">
					<img src="src1/assets/images/wo_renzhen_b_01.jpg">
					<img src="src1/assets/images/wo_renzhen_b_02.png">
				</div>
			</div>
			<h5 class="auth-rule">
